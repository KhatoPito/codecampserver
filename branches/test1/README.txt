...
Getting Started:
==============================================
To build and run this project you must first run the "click to build.bat" batch file.  This will create a July09v31 database on your local Sql Express database engine instance.
