...
namespace July09v31.UI.Controllers
{
    public class UserGroupController : SaveController<UserGroup, UserGroupForm>
    {
        ...
        public UserGroupController(IUserGroupRepository repository, IUserGroupMapper mapper, IConferenceRepository conferenceRepository, IConferenceMapper conferenceMapper, ISecurityContext securityContext)
