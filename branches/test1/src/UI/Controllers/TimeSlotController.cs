...
namespace July09v31.UI.Controllers
{
    ...
    public class TimeSlotController : SaveController<TimeSlot, TimeSlotForm>
    {
        ...
        public TimeSlotController(ITimeSlotRepository repository, ITimeSlotMapper mapper, ISessionRepository sessionsRepository, ISecurityContext securityContext)
