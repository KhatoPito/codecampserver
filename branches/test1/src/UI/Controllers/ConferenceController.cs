...
namespace July09v31.UI.Controllers
{
    ...
    public class ConferenceController : SaveController<Conference, ConferenceForm>
    {
        ...
        public ConferenceController(IConferenceRepository repository, IConferenceMapper mapper, ISecurityContext securityContext, IUserGroupRepository userGroupRepository)
