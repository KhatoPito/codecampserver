...
namespace July09v31.UI.Helpers.Mappers
{
    public class SessionMapper : AutoFormMapper<Session, SessionForm>, ISessionMapper
    {
        ...
        public SessionMapper(ISessionRepository repository, ITrackRepository trackRepository, ITimeSlotRepository timeSlotRepository, ISpeakerRepository speakerRepository)
            : base(repository)
        {
