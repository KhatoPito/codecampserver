...
namespace July09v31.UnitTests.UI
{
        ...
        where TEntity : PersistentObject, new()
    {
        ...
        public void Should_return_null_when_query_string_parameter_value_is_null()
        {
            ...
            var context = new ModelBindingContext { ModelName = "foo", ModelType = typeof(TEntity), ValueProvider = new Dictionary<string, ValueProviderResult>() };
