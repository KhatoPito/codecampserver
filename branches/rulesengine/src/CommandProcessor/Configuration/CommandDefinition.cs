...
namespace Tarantino.RulesEngine.Configuration
{
	public class CommandDefinition : ICommandConfiguration
	{
		...
		public CommandDefinition(Type operationType)
		{
			...
			Condition = new Func<object, object, bool>((original, revised) => true);
		}
		...
		public void Initialize(ICommandMessage commandMessage, ExecutionResult result)
		{
		...
		public void ApplyCondition<TMessage>(Func<TMessage, TMessage, bool> condition)
		{
			Condition = condition;
		}
