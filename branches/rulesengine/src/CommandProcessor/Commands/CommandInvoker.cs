...
namespace Tarantino.RulesEngine.CommandProcessor
{
	...
	{
		ExecutionResult Process(ICommandMessage commandMessage, ICommandConfiguration commandConfiguration);
	}
	...
	public class CommandInvoker : ICommandInvoker
	{
		...
		public ExecutionResult Process(ICommandMessage commandMessage, ICommandConfiguration commandConfiguration)
		{
